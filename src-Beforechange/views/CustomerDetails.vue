    ...
    <table class="table"  >
      ...
      <tbody>          
        <tr v-for="customers in filtered()" :key="customers.id" >     
          ...
          <td><button @click="handleEdit(customers)"><i class="bi bi-pencil"> edit</i></button></td>
          <td><button @click="handleView(customers)"><i class="bi bi-search"> view</i></button></td>          
          <td><button @click="handleDelete(customers)"><i class="bi bi-trash"></i> delete</button></td>         
